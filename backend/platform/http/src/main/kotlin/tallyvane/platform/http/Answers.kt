 ...
 *
 * Handing the factories out as a receiver closes that. Only [Problems.of] and
 * [FailureTranslator.translate] run with an `Answers` in scope, because only the renderer has one
