...
class SignInWithEmailCodeSpec : StringSpec({
    ...
    "a verified email-login challenge completes the existing authentication policy" {
        ...
        signIn.signIn(SignInWithEmailCodeRequest(challenge.id, email, code, DeviceLabel("Browser"))) shouldBe expected
