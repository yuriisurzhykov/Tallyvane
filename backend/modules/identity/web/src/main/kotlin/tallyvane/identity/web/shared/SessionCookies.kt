 ...
 */
internal interface SessionCookies {
    fun attach(call: ApplicationCall, tokens: IssuedTokens)
    fun readRefresh(call: ApplicationCall): String?
    ...
    class CookieJar(private val secure: Boolean) : SessionCookies {
         ...
         */
        override fun readRefresh(call: ApplicationCall): String? = call.request.cookies[REFRESH_COOKIE]
         ...
         */
        override fun attachRefreshOnly(call: ApplicationCall, refresh: TokenValue, refreshTtl: Duration) {
