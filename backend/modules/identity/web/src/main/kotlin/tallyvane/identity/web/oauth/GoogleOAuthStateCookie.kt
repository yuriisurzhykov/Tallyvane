...
internal interface GoogleOAuthStateCookie {
    ...
    fun link(challenge: PkceChallenge.Generated, userId: UserId, sessionId: SessionId): String
    ...
    sealed interface State {
        ...
        data class Link(override val codeVerifier: String, val userId: UserId, val sessionId: SessionId) : State
    ...
    class Cookie : GoogleOAuthStateCookie {
        ...
        override fun link(challenge: PkceChallenge.Generated, userId: UserId, sessionId: SessionId): String =
            listOf("link", challenge.state, challenge.verifier, userId.value, sessionId.value).joinToString(".")
