 ...
 * [UserId]'s KDoc gives: `domain` cannot see `contract`, so the published boundary type and this
 * module's internal one are independent by construction, not by oversight.
 */
@JvmInline
