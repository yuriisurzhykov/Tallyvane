...
public class AuthenticationPolicy(
    ...
    init {
        ...
        require(rules.all { rule -> rule.primary != PrimaryMethod.EMAIL_CODE ||
            SecondFactorKind.EMAIL_OTP !in rule.allowedMethods || rule.requirement != MfaRequirement.REQUIRED || advancedAcknowledged
    ...
    public companion object {
        public fun defaults(version: Long = 1): AuthenticationPolicy = AuthenticationPolicy(version, listOf(
            AuthenticationRule(PrimaryMethod.PASSWORD, true, MfaRequirement.IF_ENROLLED,
                setOf(SecondFactorKind.TOTP, SecondFactorKind.EMAIL_OTP, SecondFactorKind.BACKUP_CODE)),
            AuthenticationRule(PrimaryMethod.GOOGLE, true, MfaRequirement.IF_ENROLLED,
                setOf(SecondFactorKind.TOTP, SecondFactorKind.BACKUP_CODE)),
            AuthenticationRule(PrimaryMethod.EMAIL_CODE, true, MfaRequirement.IF_ENROLLED,
                setOf(SecondFactorKind.TOTP, SecondFactorKind.BACKUP_CODE)),
        ), false)
    }
}
