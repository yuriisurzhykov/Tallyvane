...
import { AdminSessionGate } from "@/views/session/ui/AdminSessionGate";
import "./globals.css";
    ...
    return (
        ...
        >
            ...
            <body className="bg-surface-primary text-text-primary">
                <ThemeProvider><ToastRegion><AdminSessionGate>{children}</AdminSessionGate></ToastRegion></ThemeProvider>
            </body>
        </html>
    );
}
